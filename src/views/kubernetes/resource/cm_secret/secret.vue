<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column width="200px" align="left" label="名称">
      ...
      <el-table-column align="center" class-name="status-col" label="类型" width="240">
        <template slot-scope="{row}">
          {{ row.secret_type }}
        </template>
      </el-table-column>

      <el-table-column align="center" class-name="status-col" label="标签" width="150">
        <template slot-scope="{row}">
          {{ row.labels }}
        </template>
      </el-table-column>
...
import {  DeleteSecret, secretList } from '@/api/configs'
